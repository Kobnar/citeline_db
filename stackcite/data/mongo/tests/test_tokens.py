...
class AuthTokenUnitTestCase(AuthTokenBaseTestCase):
    ...
    def setUp(self):
        user = testing.utils.make_user('test@email.com')
        self.api_token = testing.utils.make_auth_token(user)
    ...
    def test_user_is_readonly(self):
        ...
        """
        with self.assertRaises(AttributeError):
            self.api_token.user = testing.utils.make_user('test@email.com')
...
class ConfirmTokenUnitTestCase(ConfirmTokenBaseTestCase):
    ...
    def setUp(self):
        user = testing.utils.make_user('test@email.com', 'T3stPa$$word')
        self.conf_token = testing.utils.make_conf_token(user)
    ...
    def test_user_is_readonly(self):
        ...
        """
        with self.assertRaises(AttributeError):
            self.conf_token.user = testing.utils.make_user('test@email.com')
...
class ConfirmTokenIntegrationTestCase(ConfirmTokenBaseTestCase):
    ...
    def setUp(self):
        ...
        self.user = testing.utils.make_user('test@email.com', 'T3stPa$$word')
